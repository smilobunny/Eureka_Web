...
{	
	...
	$sql="Select * from rampwalk where username='$loginname'";
...
{	
	...
	$sql="update rampwalk set name='$name' ,college='$college',city='$city',state='$state',country='$country',pincode='$pincode',address='$address',email='$email' ,gender='$gender' ,mobileno='$mobileno',password='$password' where username='$loginname'";
...
<div class="viewdetails">
						...
						<p><span class="error">* required field.</span></p>
						     ...
						     Name      <input type="text" name="name" maxlength="30" value="<?php echo $name;?>" style="width:300px; height:35px;margin-left:200px;">
								...
								<br> <br>
															Mobile No.(optional)<input type="text" name="mobileno" value="<?php echo $mobileno;?>" style="width:300px; height:35px; margin-left:50px;" >
								<br><br>
