...
{	
	...
	$sql="Select * from sursartaj where username='$loginname'";
...
{	
	...
	$sql="update sursartaj set name='$name' ,college='$college',city='$city',state='$state',country='$country',pincode='$pincode',address='$address',email='$email' ,gender='$gender' ,mobileno='$mobileno',password='$password' where username='$loginname'";
