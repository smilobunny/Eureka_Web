...
{	
	...
	$sql="Select * from bandwars where username='$loginname'";
...
if (empty($_POST["password"])) {
   ...
   if($nameerr =="" && $collegeerr ==""&& $adderr =="" && $cityerr=="" && $stateerr=="" && $countryerr=="" && $pcodeerr=="" && $emailerr=="" && $usererr=="" && $passerr=="" && $repasserr=="")
	...
	$sql="update bandwars set teamname='$teamname' ,college='$college',city='$city',state='$state',country='$country',pincode='$pincode',address='$address',email='$email' ,mobileno='$mobileno',password='$password' where username='$loginname'";
