...
else
{
	...
	$sql="insert into table1(name,lastname) values('$username','$password')";
...
<?php include("eurmenu.php"); ?> 
					...
					<div id="site-container">
						...
						<form name="qform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" > 
						...
						<br><br>
						Your E-mail(required)<br> <input type="text" name="email" style="width:300px; height:35px; "<?php echo $email;?>">
						<span class="error">* <?php echo $emailErr;?></span>
						<br><br>
						Subject <br>
						<input type="text" name="subject"  style="width:300px; height:35px;">
