...
{	
	...
	$sql="insert into dancetransmit  (teamname,email,mobileno,college,address,city,state,country,pincode,username,password) values('$teamname','$email','$mobileno','$college','$address','$city','$state','$country','$pincode','$username','$password')";
...
<?php include("eurmenu.php"); ?> 
					...
					<img src="images/dance.png" style="margin-top:50px; border-top:50px solid #9999ff; border-bottom:50px solid #9999ff; width:1350px;">
				
					<div class="heading1">
					About The Event </div>
					<div class="para1">
			Dance is the universal language of the soul. Do you want to say something? Dance it out on the EUREKA 2015 stage. The stage is all set for you to bring out the marvel in you. The stage is all yours to set on fire with the enigma trapped in your ribcage.
					<br> <div style="color:white ;font-style:bold;font-size:34;">  Tap your feet to the best of rhythms and let the world be spellbound. Dance it out! Register Now!
					</div>
					</div>
					...
					<div class="para2">
					Abhishek Khurana  ( 8765432190 )<br>
					Pranab Sharma     ( 9988672345 )
					
					</div>
					<div class="container1" style="background-image:url(images//stoneblue.jpg); height:1300px;">
					...
					<div class="register">
						...
						<p><span class="error">* required field.</span></p>
						     ...
						     Teamname      <input type="text" name="teamname" maxlength="30" value="<?php echo $teamname;?>" style="width:300px; height:35px;margin-left:140px;">
								...
								<br> <br>
															Mobile No.(optional)<input type="number" name="mobileno" style="width:300px; height:35px; margin-left:50px;" value="<?php echo $country;?>" >
								<br><br>
