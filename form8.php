...
<head>
<title> Form1</title>
<link type="text/css" rel="stylesheet" href="css/exform8.css">
<style>
.error {color: #FF0000;}
</style>
</head>
...
{	
	...
	mysqli_select_db($con,"eureka");
	 $sql1="insert into checklogin(username,password,compid) values('$username1','$password1','$compid')";
	mysqli_query($con,$sql1);
	$sql="insert into sursartaj (name,gender,email,mobileno,college,address,city,state,country,pincode,username,password) values('$name','$gender','$email','$mobileno','$college','$address','$city','$state','$country','$pincode','$username','$password')";
...
<?php include("eurmenu.php"); ?> 
					...
					<img src="images/sursartaj.png" style="margin-top:50px; border-top:50px solid #663333; border-bottom:50px solid #663333; width:1350px;">
				
					<div class="heading1">
					About The Event </div>
					<div class="para1">
					<div style="color:#660000 ;font-style:bold;font-family:Arial ;font-size:34;">   As immortal Shakespeare said in his wise words “If music be the food of love, play on”. </div><br>
					Because we all know where words fail, music speaks. So live in music than in years. Don’t just be a nightingale who sits in darkness,come out with your sweet sounds and cheer your presence in the world.
					<br>    Just a step away from glory! Here is the perfect opportunity for you to capture the crowd with your vocal abilities! 
Open your heart out, and let the voice do it for you. Register now!</div>
					...
					<div class="container1" style="background-image:url(images//back1.jpg);">
