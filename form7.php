...
{	
	...
	$sql="insert into prodigy (name,gender,email,mobileno,college,address,city,state,country,pincode,username,password) values('$name','$gender','$email','$mobileno','$college','$address','$city','$state','$country','$pincode','$username','$password')";
...
<?php include("eurmenu.php"); ?> 
					...
					<img src="images/prodigy.png" style="margin-top:50px; border-top:50px solid #9999cc; border-bottom:50px solid #9999cc; width:1350px;">
  
					<div class="heading1">
					About The Event </div>
					<div class="para1">
									Ridding on a rollercoaster ride is a thrill.Simiarly ,playing with fuzzy logics and algorithms is a thrill and fun for a programmer. We at EUREKA 2k16 brings you a contest where you can challenge yourself with some fuzzy logical programs.You can write your code in C++,C,Java ,Python,and many other languages
					<br> <div style="color:white ;font-style:bold;font-size:34;">Come and let yourself test your programming skills . Register now!</div>
					</div>
					...
					<div class="container1" style="background-image:url(images//stone8.jpg);">
